...
class ContactInquiryAdminServiceTest {
    ...
    void getAdminInquiryList_formatsRows() {
        ...
        ContactInquiryListPageDTO result = contactInquiryService.getAdminInquiryList("demo", "OPEN", "田中", pageable);
    ...
    void getAdminInquiryList_acceptsEmptyStatusFilter() {
        ...
        ContactInquiryListPageDTO result = contactInquiryService.getAdminInquiryList(null, null, null, pageable);
