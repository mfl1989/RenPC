...
class OrderServiceTest {
    ...
    void setUp() {
        ...
        orderService = new OrderService(contactRepository, recycleOrderRepository, orderInternalNoteHistoryRepository,
    ...
    void submitOrder_sendsSubmissionNotification() {
        ...
        verify(orderNotificationService).sendOrderSubmitted(any(RecycleOrder.class), eq("受付済"), any(String.class));
    }
    ...
    void updateAdminOrderStatus_updatesCustomerNoteAndSendsNotification() {
        ...
        com.recycle.dto.OrderStatusUpdateRequestDTO request = com.recycle.dto.OrderStatusUpdateRequestDTO.builder()
                .status("KIT_SHIPPED")
                .version(0L)
        ...
        when(recycleOrderRepository.save(any(RecycleOrder.class))).thenAnswer(invocation -> invocation.getArgument(0));
